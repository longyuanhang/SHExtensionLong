...
#import "SHUncaughtExceptionHandler.h"
...
@interface SHUncaughtExceptionHandler ()
///判断程序是否继续执行
@property (assign, nonatomic) BOOL dismissed;

@end

@implementation SHUncaughtExceptionHandler
...
void HandleException(NSException *exception) {
   ...
   [[[SHUncaughtExceptionHandler alloc] init]
...
void SignalHandler(int signal) {
   ...
   NSArray *callStack = [SHUncaughtExceptionHandler backtrace];
   [userInfo setObject:callStack forKey:UncaughtExceptionHandlerAddressesKey];
